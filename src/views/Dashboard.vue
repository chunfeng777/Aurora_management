...
import { createChannelDonutOption, createLocationRoseOption, createRankingBarOption } from '@/utils/dashboardChartOptions'
...
@media(max-width:760px){.page-head{align-items:flex-start;gap:16px}.head-actions>span,.page-head p{display:none}.head-actions{flex-wrap:wrap}.title-line{align-items:flex-start;flex-direction:column;gap:6px}.location-header{align-items:flex-start;gap:12px}.scope-note{display:none}}
</style>
